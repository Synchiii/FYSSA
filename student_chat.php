...
<div class="sidebar">
 <div class="sidebar-profile">
  ...
  <a href="student_chat.php" class=active><i class="bi bi-mortarboard me-2"></i>Chat</a>
...
<!-- Chat Content -->
<div class="content">
  <h3 class="mb-4"><i class="bi bi-chat-dots me-2"></i>Chat with Instructors</h3>

  <div class="chat-container">
    <div class="user-list">
      <h6 class="p-3 text-center bg-dark text-white">Instructors</h6>
      <?php
...
<?php endwhile; ?>
    ...
    <div class="chat-box">
      ...
      <div class="messages" id="messages">
        <p class="text-center text-muted mt-5">Select an instructor to start chatting 💬</p>
      </div>

      <!-- Allow sending file only or message or both -->
...
setInterval(() => {
  // Reload user list every 5 seconds for unread updates
  fetch(window.location.href)
    ...
    .then(html => {
      ...
      document.querySelector('.user-list').innerHTML = newUserList;
    });
}, 5000);
...
function sendMessage(e) {
  ...
  // Allow sending if there's either message or file
